...
const CallInitialisingScreens = ({ navigation, route }) => {
  ...
  //  console.log(usermobilenumber,"group iddddddddddddddddddd");
    ...
    const addnumberintoconf = async () => {
        const addcallerintolive = `${baseurl}addintoconf?gid=${groupId}&user_id=${userid}&usermobile=${usermobilenumber}&contactnumber=${currentnum}&name=${currentname}&mute=0&handrise=0`;
                    ...
                    <View style={{ flexDirection: "column", justifyContent: "space-around" }}>
                        ...
                        <View style={{ padding: 30, flexDirection: "row", justifyContent: "space-between" }}>
                            <View style={{ flexDirection: "column" }}>
                                <Text style={{ color: "#fff", fontSize: 22 }}>{groupduration}</Text>
