...
import { PermissionsAndroid, StyleSheet, View, Text, Image, TextInput, Alert, TouchableOpacity } from 'react-native';
import * as Contacts from 'react-native-contacts';
import { FlatList } from 'react-native-gesture-handler';
import AsyncStorage from '@react-native-async-storage/async-storage';
import {MyContext} from '../../Context/Severcontext';

const Addusersinconf = (props) => {
                            ...
                            <>
                                <View style={{ flexDirection: "column", justifyContent: "space-evenly", alignItems: "center", flexWrap: "nowrap" }}>
                                    <TouchableOpacity
                                        ...
                                        <View><Text style={{ fontWeight: "500", color: "grey", marginHorizontal: 10 }}>{item.contact_display_name}</Text></View>
                                    </TouchableOpacity>
                                </View>
                            </>
                        )
                        ...
                        return (
                            <>
                                    <View style={styles.userslistbox}>
                                       <TouchableOpacity
                                        onPress={async () => {
                                            await onEditabledone(usercontacts[0], findNames);
                                            await getAddedparticipates();
                                        }}
