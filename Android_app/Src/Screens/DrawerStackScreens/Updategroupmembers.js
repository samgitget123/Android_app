    ...
    return (
        <>
            ...
            <TouchableOpacity onPress={async () => {
                ...
                }} style={{ marginTop: 20, marginRight: 50, flexDirection: "row", justifyContent: "flex-end" }}>
                <View >
                    <Text style={{ color: "red", opacity: 0.75, marginBottom:20 }}>{(countofquickcallusers > 0) ? (<Text>Delete All</Text>) : null}</Text>
                    </View>
                </TouchableOpacity>
