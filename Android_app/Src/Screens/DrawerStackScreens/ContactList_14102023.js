...
const ContactList = (props) => {
    ...
    return (
        <>
            ...
            <View style={{ margin: 20, marginRight: 50, flexDirection: "row", justifyContent: "flex-end" }}>
                <TouchableOpacity onPress={async () => {
                    await deleteallgroupmembers()

                }}>
                    <Text style={{ color: "red", opacity: 0.75 }}>{(countofquickcallusers) ? (<Text>Delete All</Text>) : null}</Text>
                </TouchableOpacity>
            </View>
